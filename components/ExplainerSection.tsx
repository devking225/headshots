...
export default function ExplainerSection() {
  return (
    <div className="w-full px-20 mt-16 p-8 bg-gray-100 rounded-lg space-y-8 lg:py-10 border-b border-t border-orange-100 bg-orange-50 items-center py-8">
      <h2 className="text-5xl font-bold text-[#1c1844]">How It Works</h2>

      <div className="w-full flex flex-col lg:flex-row items-center">
        <div className="lg:w-1/3 w-full mt-2 md:px-4">
          {/* Step 1: Upload your images */}
          <div className="space-y-4 text-[#1c1844]">
            <div className="flex items-center justify-center space-x-4">
              <div className="text-3xl font-bold text-[#1c1844] bg-white border-2 border-blue-600 rounded-full w-10 h-10 flex items-center justify-center">
                1
              </div>
        ...
        <div className="lg:w-1/3 w-full mt-2 md:px-4 text-[#1c1844]">
