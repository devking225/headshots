...
export default function ExplainerSection() {
  return (
    <div className="w-full px-20 mt-16 p-8 bg-gray-100 rounded-lg space-y-8 lg:py-10 border-b border-t border-orange-100 bg-orange-50 items-center py-8">
      <h2 className="text-5xl font-bold text-[#167ef9]">How It Works</h2>
        ...
        <div className="lg:w-1/3 w-full mt-2 md:px-4">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-center space-x-4">
              <div className="text-3xl font-bold text-[#167ef9] bg-white border-2 border-blue-600 rounded-full w-10 h-10 flex items-center justify-center">
                1
              </div>
