            ...
            <div className='flex flex-col items-center pt-16 px-20'>
                <div className="w-full">
                    <div className="mx-auto text-left md:text-center">
                        <h1 className="mt-3 text-2xl py-6 font-bold tracking-[-1.05px] sm:text-3xl lg:text-[42px] text-primary-500 lg:leading-[48px]">
                    ...
                    <div className="p-6 relative bg-white border rounded-lg border-primary-500/15 shadow-[0px_0px_75px_0px_rgba(0,0,0,0.07)] flex flex-col justify-between">
                        <div className="flex-1 space-y-2 flex">
                            <div className='w-[300px]'>
                                <a href="/best-ai-headshot-generators" className="">
                            ...
                            <div className='w-full px-8'>
                                ...
                                <div className="mt-3">
                                    <a href="/best-ai-headshot-generators" className="text-base flex items-center justify-center w-[300px] font-medium text-[#240D0D] border border-[#E6E6E6] hover:opacity-80 transition-all duration-150 bg-[#EEEEEE] rounded-lg px-4 pt-2 pb-2.5 h-10" role="button">
                                        Read article
                                    </a>
                                </div>
                            </div>
